CLASS zcl_carga_biblioteca_a02 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_carga_biblioteca_a02 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA: lt_acc_categ TYPE TABLE OF ztb_acc_categ_a2,
          lt_catego    TYPE TABLE OF ztb_catego_a02,
          lt_clientes  TYPE TABLE OF ztb_clientes_a02,
          lt_clnts_lib TYPE TABLE OF ztb_clnts_lib_a2,
          lt_libros    TYPE TABLE OF ztb_libros_a02.
...
"Delete possible entries; insert new entries
    DELETE FROM ztb_catego_a02.
    INSERT ztb_catego_a02 FROM TABLE @lt_catego.

******** ZTB_CATEGO ********
 "fill internal table
     lt_clientes = VALUE #( ( id_cliente = '005638984K' tipo_acceso = '1' nombre = 'Andrew' apellidos = 'Roberts' email = 'STEPHANIE.ROBERTS@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/11/24.2.png' )
     ...
     ( id_cliente = '049573865T' tipo_acceso = '1' nombre = 'Faith' apellidos = 'Black' email = 'DAN.BLACK@EMAIL.COM' url = 'https://d4.logaligroup.com/wpcontent/uploads/2019/11/24.2.png' )
     ...
     ( id_cliente = '283748858A' tipo_acceso = '5' nombre = 'Eric' apellidos = 'Knox' email = 'LILY.KNOX@EMAIL.COM' url = 'https://d4.logaligroup.com/wpcontent/uploads/2019/11/24.2.png' )
...
"Delete possible entries; insert new entries
    DELETE FROM ztb_clientes_a02.
    INSERT ztb_clientes_a02 FROM TABLE @lt_clientes.
...
******** ZTB_LIBROS ********
 "fill internal table
     lt_libros = VALUE #( ( id_libro = '000001' bi_categ = 'A' titulo = 'Diccionario de los sentimientos' autor = 'CAGIGAL, Jose Maria' editorial = 'ANAGRAMA' idioma = 'S' paginas = 350 precio = '84.99' moneda = 'USD' formato = 'E' url =
'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-elproceso-de-edici%C3%B3n.jpg' )
...
"Delete possible entries; insert new entries
     DELETE FROM ztb_libros_a02.
     INSERT ztb_libros_a02 FROM TABLE @lt_libros.
     "Check result in console
     new_variable = out->write( sy-dbcnt ).
     out->write( 'DONE!' ).
